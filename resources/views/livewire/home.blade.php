    ...
    <div >
        ...
        <div class="card card-custom bg-gray-100 card-stretch gutter-b">
            ...
            <div class="card-header border-0 bg-success py-5">
                <h3 class="card-title font-weight-bolder text-white">{{ Auth::user()->name ?? '' }}<x-tag-a :route="route('logout')" :name="__('customTrans.Logout')" default_class="btn bg-secondary mx-4 "
                    style="width: 100px; height: 38px; font-size:13px;"></x-tag-a></h3>
                    ...
                    <div class="row m-0">
                        <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                            <span
                                ...
                                </svg><!--end::Svg Icon--></span> <a href="  {{ route('aid.create') }}"
                        ...
                        <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                            <span
                                ...
                                </svg><!--end::Svg Icon--></span> <a href=" {{ route('support.show') }}"
